                  ...
                  (o.onreadystatechange = function() {
                    4 === o.readyState &&
                      ((o.status < 400 && t.local) || 200 === o.status
                        ? (n.JSON ? (s = JSON.parse(o.responseText)) : a(new Error('JSON is not supported')), r(s))
                        : a(o.status ? o.statusText : 'Attempted cross origin request without CORS enabled'));
                  }),
                  o.send();
              });
            return (
        ...
        (function(t) {
          ...
          (n.GeoJSON.AJAX = n.GeoJSON.extend({
            ...
            initialize: function(e, t) {
              (this.urls = []),
                e && ('string' == typeof e ? this.urls.push(e) : 'function' == typeof e.pop ? (this.urls = this.urls.concat(e)) : ((t = e), (e = void 0)));
          ...
          t.exports = function(e, t) {
            ...
            var o,
              ...
              f = new a(function(r, a) {
                ...
                t.callbackName ? (o = t.callbackName) : ((s = '_' + ('' + Math.random()).slice(2)), (o = '_leafletJSONPcallbacks.' + s)),
                  (c.type = 'text/javascript'),
                  s &&
                    (n._leafletJSONPcallbacks || (n._leafletJSONPcallbacks = { length: 0 }),
